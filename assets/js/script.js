...
function darkAndLightMode() {
    ...
    document.addEventListener('click', e => {
        ...
        if (el.classList.contains('dark-mode-btn-change')) {
            ...
            verTodosProjetos.innerHTML = `<h2><a href="https://github.com/Joaomos" target="_blank">Ver todos projetos <img src="img/seta para frente white.svg" alt="seta para frente"></a></h2>`;
        ...
        if (el.classList.contains('light-mode-btn')) {
            ...
            verTodosProjetos.innerHTML = `<h2><a href="https://github.com/Joaomos" target="_blank">Ver todos projetos <img src="img/seta para frente.svg" alt="seta para frente"></a></h2>`;
